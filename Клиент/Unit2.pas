...
//задаём размеры формы карточки заказа
cardForm.Height := Screen.Height - 50;
//задаём системную дату для DateTimePicker'ов
...
//задаём надписи
Label1.Caption := 'карточка заказа №';  Label2.Caption := 'менеджер';  Label3.Caption := 'заказчик';
Label33.Caption := 'код в АТИ'; Label36.Caption := 'код в АТИ';
Label4.Caption := 'маршрут';  Label5.Caption := 'адрес погрузки';  Label6.Caption := 'дата погрузки';
Label7.Caption := 'время погрузки';  Label8.Caption := 'контактное лицо';  Label9.Caption := 'груз';
Label10.Caption := 'вес груза'; Label11.Caption := 'требуемый подвижной'; Label12.Caption := 'особые условия';
Label13.Caption := 'адрес выгрузки'; Label14.Caption := 'дата выгрузки'; Label15.Caption := 'время прибытия';
Label16.Caption := 'контактное лицо'; Label17.Caption := 'ставка брутто'; Label18.Caption := 'форма оплаты';
Label19.Caption := 'потери'; Label20.Caption := 'ставка нетто'; Label21.Caption := 'перевозчик';
Label22.Caption := 'водитель'; Label23.Caption := 'Телефон 1'; Label32.Caption := 'Телефон 2'; Label24.Caption := 'а/м';
Label25.Caption := 'ставка'; Label26.Caption := 'форма оплаты'; Label27.Caption := 'срок оплаты';
Label28.Caption := 'факт. дата выгрузки'; Label29.Caption := 'ТТН получена'; Label30.Caption := 'ТТН, счет отправлен';
Label31.Caption := 'поступление от заказчика';
Label34.Caption := 'долг'; Label35.Caption := 'оплачено перевозчику';
Label38.Caption := 'долг'; Label39.Caption := 'наш остаток';
Label40.Caption := 'Примечания'; Label41.Caption := 'Заказ закрыт';
//задаём расположение надписей в зависимости от их размера
...
Button1.Caption := 'Печать заявки'; Button2.Caption := 'формирование счета';
Button3.Caption := 'формирование сч-фк'; Button4.Caption := 'формирование акта вр';
//настройка полей "Форма оплаты"
comboBox2.Items.Clear;
comboBox2.Items.Add('?'); comboBox2.Items.Add('нал');
comboBox2.Items.Add('безнал'); comboBox2.Items.Add('с НДС');
...
if Sender = Button6 then
  begin
    ...
    driversForm.Caption := 'Водители';
    Unit2.ArrayLenth := 15;
  end
else
  begin
    SenderGrid := listForm.GridC;
    driversForm.Caption := 'Контрагенты';
    Unit2.ArrayLenth := 30;
    SenderEdit1 := Edit1;
    SenderEdit2 := Edit12;
  end;
...
with Sender as TComboBox do
  ...
  if (comboBox2.Text <> '?')and(comboBox5.Text <> '?')
      ...
      if comboBox2.Text='с НДС' then
        if comboBox5.Text='с НДС' then
