...
Button1.Caption := 'OK';
CheckBox3.Caption := 'Дата заявки';
CheckBox4.Caption := 'Код менеджера'; CheckBox5.Caption := 'Заказчик'; CheckBox6.Caption := 'код в АТИ';
CheckBox7.Caption := 'Маршрут'; CheckBox8.Caption := 'Груз'; CheckBox9.Caption := 'ставка БРУТТО';
CheckBox10.Caption := 'форма оплаты'; CheckBox11.Caption := 'прочие потери'; CheckBox12.Caption := 'частичная оплата';
CheckBox13.Caption := 'ставка НЕТТО'; CheckBox14.Caption := 'Перевозчик'; CheckBox15.Caption := 'код в АТИ';
CheckBox16.Caption := 'Ставка перевозчика'; CheckBox17.Caption := 'форма оплаты'; CheckBox18.Caption := 'частичная оплата';
CheckBox19.Caption := 'наш остаток'; CheckBox20.Caption := 'фамилия водителя'; CheckBox21.Caption := '№ а/м';
CheckBox22.Caption := '№ прицепа'; CheckBox23.Caption := 'Дата загрузки'; CheckBox24.Caption := 'Дата разгрузки';
CheckBox25.Caption := 'Сумма получена'; CheckBox26.Caption := 'Сумма выплачена'; CheckBox27.Caption := 'закрытие рейса';
CheckBox28.Caption := 'Дата заявки'; CheckBox29.Caption := 'Примечания';
end;
